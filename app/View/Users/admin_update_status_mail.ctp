		...
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">
			...
			<div class="content-box content-box-header" style="border:none;">
				...
				<div class="column-content-box">
					...
					<div id="tabs"> 
                     <?php echo $this->Form->create('SendMail',array('id'=>'sendMailUpdateStatus','url'=>array('controller'=>'users','action'=>'update_status_mail/'.$m_id))); ?>
						<div id="tabs1">
								...
								<fieldset>
									<ul>
										...
										<li>
                                            ...
                                            <input class="sub-bttn" type="submit" value="Update Status"/>
