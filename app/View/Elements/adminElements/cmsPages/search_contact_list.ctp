<?php /*?><a href="<?php echo HTTP_ROOT.'admin/Users/contact_search_result/'.$qryStr; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:10px; margin-bottom:10px; margin-right:6px;">Download Excel</a><?php */?>

<?php 
if(isset($qryStr)){
		$this->Paginator->options(array('url' => array('controller'=>'Users','action'=>'admin_contactSearch','condition'=>$qryStr)));
}
?>
<div id="page-content">
