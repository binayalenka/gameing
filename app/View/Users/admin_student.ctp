...
<div id="sub-nav">
	<div class="page-title">
		<h1>Students<?php echo '  ( Total Registered Users = '.$counter.')'; ?></h1>
	</div>
</div>
	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">        
			<div class="inner-page-title">
                ...
                <a href="<?php echo HTTP_ROOT.'admin/Users/add_student'; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:-10px;">Add Student</a>
			...
			<div class="content-box content-box-header" id='check'>
            	<div class="loadPaginationContent">				
					<?php echo $this->element('adminElements/teacher/student_list');?>
                </div>   
