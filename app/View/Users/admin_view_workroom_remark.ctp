	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">
			<div class="inner-page-title">
				<h2 style="width:90%; ">Comment Details</h2>
			...
			<div class="hastable">			
                            ...
                            <tbody>
                                ...
                                <tr>							
                                    ...
                                    <td width="30%;"><?php echo ucwords($info['WorkroomPostRemark']['remark']); ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">Date Added</th> 
                                    <td width="30%;"><?php echo $info['WorkroomPostRemark']['date_added']; ?></td> 
                                </tr>
