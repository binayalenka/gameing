		...
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">
			...
			<div class="content-box content-box-header" style="border:none;">
				...
				<div class="column-content-box">
					...
					<div id="tabs"> 
                     <?php echo $this->Form->create('SendMail',array('class'=>'editTemplateForm','id'=>'sendMail','url'=>array('controller'=>'users','action'=>'send_mail/'.$id))); ?>
						<div id="tabs1">
								<div class="content-box-wrapper">
								<?php echo $this->Form->input('id',array('type'=>'hidden','value'=>$id,'div'=>false,'label'=>false));?> 	
								<fieldset>
									<ul>
										<li>
