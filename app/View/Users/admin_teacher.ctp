	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">        
			<div class="inner-page-title">
				<h2>Instructors Listing</h2>
                <a href="<?php echo HTTP_ROOT.'admin/users/add_instructor'; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:-10px;">Add Instructor</a>
            ...
            <div class="search" >
                <h2>Search</h2>
                <?php echo $this->Form->create('Member',array('id'=>'searchTeacher')); ?>
