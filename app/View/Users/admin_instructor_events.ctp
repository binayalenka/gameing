	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">
			<div class="inner-page-title">
				<h2>View classes, broadcasts and pending approval of an instructors </h2>
            ...
            <div class="search" style="display:none">
                <h2>Search</h2>
                <?php echo $this->Form->create('Member',array('id'=>'searchInstructorForEvent')); ?>
                    ...
                    <div class="search_contents" style="margin-top:19px;">                        
                        <?php echo $this->Form->submit('Search',array('div'=>false,'label'=>false,'id'=>'searchInstructorForEventSubmit','class'=>'field text full txtts_inproperty')); ?>
            ...
            <div class="content-box content-box-header" style="border:none;">			
                <div class="loadPaginationContent">	
                    <?php echo $this->element('adminElements/cmsPages/instructor_events_list'); ?>
                </div>
            </div>
