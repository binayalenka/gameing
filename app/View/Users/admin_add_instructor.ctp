			...
			<div class="content-box content-box-header" style="border:none;">
				...
				<div class="column-content-box">
					...
					<div class="ui-state-default ui-corner-top ui-box-header">
					 ...
					 <?php echo $this->Form->create('Member',array('id'=>'UserName','url'=>array('controller'=>'Users','action'=>'add_instructor','admin'=>true),'enctype'=>'multipart/form-data')); ?>
                    <div class="content-box-wrapper">
                    <?php echo $this->Form->input('terms',array('type'=>'hidden','value'=>'1','readonly'=>true,'div'=>false,'label'=>false)); ?>
                    <?php echo $this->Form->input('member_type',array('type'=>'hidden','value'=>'1','readonly'=>true,'div'=>false,'label'=>false)); ?>
                    <fieldset>
                    <ul>
                        <li>
                        ...
                        <?php /*?> <li>
                            <label class="desc" >Member Type</label>
                            <div class="radioButton">
                                <?php echo $this->Form->input('member_type',array('type'=>'radio','div'=>false,'class'=>'radioBox','value'=>'1','legend'=>false,'options'=>array('1'=>'Instructor','2'=>'Student'),'separator'=>'</div><div class="radioButton">')); ?>
                             	<p class="tutor-add-Error1" id="err_member_type"><?php if(isset($error['member_type'][0])) echo $error['member_type'][0]; ?>  </p>   
                            </div>
                        </li><?php */?>
