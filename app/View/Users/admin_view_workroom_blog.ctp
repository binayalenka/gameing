			...
			<div class="hastable">			
                            ...
                            <tbody>
                                <tr>							
                                    ...
                                    <td width="30%;"><?php echo $info['WorkroomPost']['title']; ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">File/Picture/video</th> 
                                    <td width="30%;">
									<?php // echo ucwords($info['Blog']['description']); ?>
                                    <?php if($info['WorkroomPost']['m_type']==1){
												$path='/image/';
											}else{
												$path='/';
											}
									?>
									<?php
									if(!empty($info['WorkroomPost']['image'])){
										$imgArray = array('jpg','jpeg','png','gif');
										$docArray = array('doc','docx');
										
										$ext = explode('.',$info['WorkroomPost']['image']);
										if(in_array($ext[1],$imgArray)){
											echo $this->Html->image('../files/'.$info['WorkroomPost']['m_id'].$path.$info['WorkroomPost']['image'],array('style'=>'width:400px;height:300px;'));	
										}elseif(in_array($ext[1],$docArray)){
											echo $this->Html->image(HTTP_ROOT.'img/docDownload.png',array('url'=>'../../files/'.$info['WorkroomPost']['m_id'].$path.$info['WorkroomPost']['image'],'style'=>'width:100px;height:100px;cursor:pointer','title'=>'click here to download this document.','alt'=>$info['WorkroomPost']['image']));
										}
									}elseif($info['WorkroomPost']['image']== NULL && $info['WorkroomPost']['video_link']!= NULL){ ?>
									
										<iframe width="400px" height="202px" src="<?php echo $info['WorkroomPost']['video_link'];?>" frameborder="0" allowfullscreen></iframe>
									<?php }
									?>
                                ...
                                <tr>							
                                    ...
                                    <td width="30%;"><?php echo ucwords($info['WorkroomPost']['description']); ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">Date Added</th> 
                                    <td width="30%;"><?php echo $info['WorkroomPost']['date_added']; ?></td> 
                                </tr>
