          		...
          		<div class="new_registration_outr">
                	<div class="new_registration_inner"> 
                    	<div class="mid_innerbg_signup"> 
							...
							<?php echo $this->Form->create('Member',array('url'=>array('controller'=>'Homes','action'=>'registration'),'id'=>'homeIndex')); ?>
								
								<div class="outer_signupyu">
                                	<div class="mid_chkboxarea_new" style="margin-bottom:15px;">
									<?php if(!empty($inviteCode) && $check!='searchPage'){
                                            echo $this->Form->input('member_type',array('type'=>'hidden','value'=>'2','div'=>false));
                                        }else{
                                            $options = array('1'=>'Instructor','2'=>'Student');
                                            echo $this->Form->input('member_type',array('type'=>'radio','div'=>false,'class'=>'radioBox','legend'=>false,'options'=>$options)); 
                                        }
										if(isset($e_id) && isset($e_id)){
											echo $this->Form->input('e_id',array('type'=>'hidden','value'=>$e_id,'div'=>false));
											echo $this->Form->input('check',array('type'=>'hidden','value'=>$check,'div'=>false));
										}
										?>
                                    </div>
									...
									<div class="mid_rightforms_news" style="margin-bottom: 10px; width: 415px;">
                                    ...
                                    <div class="mid_rightforms_new hideInvitcode">
                                      <label><?php echo __('<b>Invite Code</b>');?></label>
                                        <?php 
										...
										echo $this->Form->input('invite_code',array('type'=>'text','div'=>false,'label'=>false,'style'=>'height:30px;','value'=>$code)); ?>
                                        <p class="error_msgs" id="err_invite_code"><?php if(isset($error['invite_code'][0])) echo $error['invite_code'][0]; ?>  </p>
                                    </div>
                                    ...
                                    <?php /*?><div class="container_sgnupwid">
                                    	<div class="signup_fb">
                                        	<a href="javascript:void(0)" onclick="login();" id="fb_sp"><?php echo $this->Html->image('sgn_fb.png');?></a>
                                        </div>
                                        <div class="img_or">
                                        	<?php echo $this->Html->image('or_img.png');?>
                                        </div>
                                        <div class="signup_gplus">
                                        	<a href="#"><?php echo $this->Html->image('sgn_gpl.png');?></a>
                                        </div>
                                    </div><?php */?>
								</div>
                            </div>
