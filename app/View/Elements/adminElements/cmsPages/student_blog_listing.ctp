<?php $this->Paginator->options(array('url' => array('controller'=>'Users','action'=>'blogs','admin'=>true))); ?>
<div id="page-content">
						...
						?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="View" href="<?php echo HTTP_ROOT."admin/users/edit_blog/".$id; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
