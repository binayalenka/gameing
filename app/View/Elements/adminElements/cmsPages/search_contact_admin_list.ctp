<a href="<?php echo HTTP_ROOT.'admin/Users/contact_admin_result/'.$qryStr; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:10px; margin-bottom:10px; margin-right:6px;">Download Excel</a>

<?php 
if(isset($qryStr)){
		$this->Paginator->options(array('url' => array('controller'=>'Users','action'=>'admin_contactAdminSearch','condition'=>$qryStr)));
}
?>
<div id="page-content">
