			...
			<div class="content-box content-box-header" style="border:none;">
				...
				<div class="column-content-box">
					...
					<div class="ui-state-default ui-corner-top ui-box-header">
					 ...
					 <?php echo $this->Form->create('Blog',array('id'=>'BlogId','url'=>array('controller'=>'Users','action'=>'add_blog','admin'=>true))); ?>
                    <div class="content-box-wrapper">
                 	
					<?php echo $this->Form->input('mem_id',array('type'=>'hidden','value'=>$mem_id,'div'=>false,'label'=>false,'class'=>'text full field required'));?> 
