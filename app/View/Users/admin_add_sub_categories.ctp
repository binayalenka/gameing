			...
			<div class="content-box content-box-header" style="border:none;">
				...
				<div class="column-content-box">
					...
					<div class="ui-state-default ui-corner-top ui-box-header">
					 ...
					 <?php echo $this->Form->create('SubCategory',array('id'=>'subCateId','url'=>array('controller'=>'Users','action'=>'add_sub_categories','admin'=>true))); ?>
                    ...
                    <ul>
                    	<li>
                            ...
                            <div>
                            	<?php echo $this->Form->input('c_id',array('type'=>'select','options'=>array(''=>__('Select'),$category_list),'div'=>false,'label'=>false,'class'=>'text full field required')); ?> 
                        ...
                        <li>
                            <input class="sub-bttn" type="submit" value="Submit" onclick='return ajax_form("subCateId","Users/validate_add_sub_categories_ajax","newloading")'/>
