			...
			<div class="hastable">			
                            ...
                            <tbody>
                            	...
                            	<tr>							
                                    ...
                                    <td width="30%;"><?php echo $info['ContactAdmin']['subject']; ?></td> 
                                </tr>
                               	<tr>							
                                    <th width="10%;">Message</th> 
                                    <td width="30%;"><?php echo $info['ContactAdmin']['message']; ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">Date Added</th> 
                                    <td width="30%;"><?php echo date('d-M-Y',strtotime($info['ContactAdmin']['date_added'])); ?></td> 
                                </tr>
