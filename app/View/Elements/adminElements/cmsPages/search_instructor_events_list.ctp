<a href="<?php echo HTTP_ROOT.'admin/Users/instructor_download_result/'.$qryStr; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:10px; margin-bottom:10px; margin-right:6px;">Download Excel</a>

<?php 
if(isset($qryStr)){
		$this->Paginator->options(array('url' => array('controller'=>'Users','action'=>'instructorEventSearch','admin'=>true,'condition'=>$qryStr)));
}
?>
<div id="page-content">
						...
						?>
								<tr>
									...
									<td >
                                        ...
                                        <a title="View Pending Approval" href="<?php echo HTTP_ROOT."admin/Users/broadcasts/".$id; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
