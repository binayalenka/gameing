...
<div id="sub-nav">
	<div class="page-title">
		<h1>Instructor Classes Listing</h1>
	</div>
</div>
	...
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">        
			<div class="inner-page-title">
				<h2>Instructor Classes Listing</h2>
                <a href="<?php echo HTTP_ROOT.'admin/users/add_event/'.$id; ?>" class="ui-state-default ui-corner-all float-right ui-button" style="margin-top:-10px;">Add Class</a>
            ...
            <?php /*?><div class="search">
                <h2>Search</h2>
                <?php echo $this->Form->create('Event',array('id'=>'searchEvent')); ?>
                        ...
                        <div class="search_contents" style="margin-top:19px;">                        
                        	<?php echo $this->Form->submit('Search',array('div'=>false,'label'=>false,'id'=>'searchEventRecord','class'=>'field text full txtts_inproperty')); ?>
			...
			<div class="content-box content-box-header" id='check'>
            	<div class="loadPaginationContent">				
					<?php echo $this->element('adminElements/events/events_list');?>
                </div>   
             </div>
