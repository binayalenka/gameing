<?php $this->Paginator->options(array('url' => array('controller'=>'Users','action'=>'admin_student_events'))); ?>
<div id="page-content">
						...
						?>
								<tr>
									...
									<td >
										...
										?>
										<?php //echo $memberType;?>
										<a title="View Class" href="<?php echo HTTP_ROOT."admin/Users/events_student/".$id; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
											<span class="ui-icon ui-icon-search"></span>
										</a>
                                         <a title="View BroadCast" href="<?php echo HTTP_ROOT."admin/Users/bulletins/".$id; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
