...
<div id="sub-nav">
	<div class="page-title">
		<h1>Student Invitation Details</h1>
	</div>
</div>
<div id="page-layout">
	<div id="page-content">
		<div id="page-content-wrapper" class="no-bg-image wrapper-full">
			<div class="inner-page-title">
				<h2 style="width:90%; ">Student Invitation Information</h2>
			...
			<div class="hastable">			
                            ...
                            <tbody>
                                ...
                                <tr>							
                                    ...
                                    <td width="30%;"><?php echo ucwords($info['Event']['title']); ?></td> 
                                </tr>
                                <tr>							
                                ...
                                <tr>							
                                    ...
                                    <td width="30%;"><?php echo $info['SendInvitation']['invite_code']; ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">Status</th> 
                                    <td width="30%;"><?php echo $info['SendInvitation']['status']; ?></td> 
                                </tr>
                                <tr>							
                                    <th width="10%;">Date Added</th> 
                                    <td width="30%;"><?php echo date('d-M-Y',strtotime($info['SendInvitation']['date_added'])); ?></td> 
                                </tr>
