	...
	<div class="mid_sectionholders">
		<div class="mid_outerarea">
        	...
        	<?php if($this->Session->check('SuccessMessage')) { ?>
             ...
             <?php } ?>
          		<div class="mid_txtarea">
                    <div class="mid_textsleft">
                    		
                         <div class="mid_txtholders">                         	
                            <div class="mid_lefttextsyo mid_leftactive">
                                <h5> <?php echo $instructorInfo['CmsPage']['page_title'];?> </h5>                             
                               <span>
                                   <?php
                                        echo $this->Text->truncate($instructorInfo['CmsPage']['description'],300,array('exact'=>false,'ending'=>'.....'));
                                    ?>
                                    <br />
                                    <?php echo $this->Html->link('View More',HTTP_ROOT.'Homes/view_cms/'.base64_encode(convert_uuencode($instructorInfo['CmsPage']['id'])));?>
                                </span>
                            </div>
                            <div class="mid_lefttextsyo mid_leftactive">
                                <h5> <?php echo $studentInfo['CmsPage']['page_title'];?>	</h5>                             
                                <span>
                                    <?php
                                        echo $this->Text->truncate($studentInfo['CmsPage']['description'],300,array('exact'=>false,'ending'=>'.....'));
                                    ?>
                                <br />
                                 <?php echo $this->Html->link('View More',HTTP_ROOT.'Homes/view_cms/'.base64_encode(convert_uuencode($studentInfo['CmsPage']['id'])));?>
                                 <div class="search_btton">
								<?php echo $this->Html->link('Search Instructor',array('controller'=>'Homes','action'=>'search_instructor'),array('escape'=>false,'class'=>'button_image_for_all_in'));?>
							</div>
                                </span>
                                
                            </div>
                            <div class="mid_lefttextsyo mid_leftactive">
                                <h5> <?php echo __('Class Requests'); ?></h5>                             
                               <span>
									<?php if(!empty($classRequest)) { ?>
                                        <marquee direction="up" class="txt_decorate" height="135" loop="true" behavior="scroll" scrollamount="2" onmouseover="this.stop();" onmouseout="this.start();" >
                                            <?php foreach($classRequest as $requests) { ?>
                                                <?php echo $requests['ClassRequest']['name']." from ".$requests['ClassRequest']['city'].", ".$requests['ClassRequest']['state'].", ".$requests['ClassRequest']['country']." <br /> looking for ".$requests['Category']['name']." Class<br /><br />" ?> 
                                                
                                                <?php /*?><b class="bold_tag"> <?php echo __('Request for Class:');?> </b><?php echo $requests['Category']['name']; ?>  
                                                <br />
                                                
                                                <b class="bold_tag"> <?php echo __('Description:');?> </b><?php echo $requests['ClassRequest']['class_description']; ?> 
                                                <br /><br /><?php */?>
                                            <?php } ?>
                                        </marquee>
                                    <?php } else {?>
                                    	<b style="text-align:center !important;"><?php echo __('No record found');?></b>
									<?php } ?>
                               </span> 
                    ...
                    <div class="mid_rightholders" id="homeIndexDiv">
						<div class="mid_rightinner">
							<div class="mid_innerbg"> 
							...
							<?php echo $this->Form->create('Member',array('url'=>array('controller'=>'Homes','action'=>'index'),'id'=>'homeIndex')); ?>
                                ...
                                <div class="mid_chkboxarea" style="margin-top:10px;">
                                ...
                                <div class="mid_rightforms" style="margin-top:10px;">
                                	<label><?php echo __('Enter Captcha Code');?><em class="mandatory">*</em></label>
									<?php echo $this->Form->input('captcha',array('type'=>'text','div'=>false,'label'=>false)); ?>
